...
# we will not be using the gpio from here.
# we will be making calls to the picoW instead using phew.
# there are still some setup aptions that need to be configured in the rest of the code.
# and most of this code will become a unique animal.


# no need for this here since we will not be running on an Rpi here.
